...
- (void)startToChangePassword
{
    ...
    NSDictionary *bodyData = @{@"loginNo":[NSString stringWithFormat:@"%@",weakSelf.inAppSetting.loginNo],
                               @"type":[NSString stringWithFormat:@"%@",weakSelf.inAppSetting.type],
                               @"oldpassword":[NSString stringWithFormat:@"%@",weakSelf.inAppSetting.password],
